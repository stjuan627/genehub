...
#[ContentEntityType(
  ...
  links: [
    ...
    'version-history' => '/admin/content/products/generic/{product_generic}/revisions',
    'revision' => '/admin/content/products/generic/{product_generic}/revisions/{product_generic_revision}/view',
    'revision-revert-form' => '/admin/content/products/generic/{product_generic}/revisions/{product_generic_revision}/revert',
    'revision-delete-form' => '/admin/content/products/generic/{product_generic}/revisions/{product_generic_revision}/delete',
  ...
  revision_table: 'product_generic_revision',
  revision_data_table: 'product_generic_field_revision',
...
final class GenericProduct extends EditorialContentEntityBase implements EntityOwnerInterface {
