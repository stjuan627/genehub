...
use Drupal\genehub_solidex\Entity\SolidexProduct;

/**
 * Access control handler for SOLIDEX products.
 */
final class SolidexProductAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResult {
    if (!$entity instanceof SolidexProduct) {
